...
<html>
    ...
    <body>   
        ...
        <p>Bonjour <?php echo $_SERVER['HTTP_USER_AGENT'] . ', ' . 'saviez vous que votre adresse ip était : ' . $_SERVER['REMOTE_ADDR'] . ' ' . 'et que le nom du serveur est' . ' ' . $_SERVER['SERVER_NAME'] . ' ' . '?'; ?></p>
